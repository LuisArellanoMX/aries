...
const obtenerProductos = async () => {
    ...
    for (const producto of productos) {
        ...
        $celdaNombre.innerText = producto.nombre_producto;
        ...
        $linkEditar.href = "../html/editar_producto.php?id=" + idProducto; 
        ...
        $botonEliminar.onclick = async () => {
            ...
            if (respuestaConfirmacion.value) {
                const url = `../../controladores/eliminar_producto.php?id=${idProducto}`;
