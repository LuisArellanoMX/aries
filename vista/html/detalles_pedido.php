        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item px-lg-4"><a class="nav-link text-uppercase" href="list_materiales">Materiales</a></li>
                        ...
                        <div class="bg-faded rounded p-5">
                            <div class="columns">
                                <div class="column is-one-third">
                                    <h2 class="is-size-2">Detalles Pedido</h2>
                                    <div class="field">
                                        <label for="nombre">Nombre del cliente</label>
                                        <label for="nombre" class="" id="nombre"></label>
                                    </div>
                                    <div class="field">
                                        <label for="direccion">Direccion</label>
                                        <label for="direccion" class="" id="direccion"></label>
                                    </div>
                                    <div class="field">
                                        <label for="telefono">Telefono</label>
                                        <label for="telefono" class="" id="telefono"></label>
                                    </div> 
                                    <div class="field">
                                        <label for="producto">Producto</label>
                                        <label for="producto" class="" id="producto"></label>
                                    </div> 
                                    <div class="field">
                                        <label for="descripcion">Descripcion</label>
                                        <label for="descripcion" class="" id="descripcion"></label>
                                    </div> 
                                    <div class="field">
                                        <label for="precio">Precio</label>
                                        <label for="precio" class="" id="precio"></label>
                                    </div> 
                                    <div class="field">
                                        <img src="" alt="" id="foto">
                                    </div> <br>
                                        <div class="control">
                                            <button onclick="location.href= 'empleado.php'" type="button" id="btnVolver" class="btn btn-danger" style="color: white !important;">Volver</button>
                            ...
                            <script src="../js/detalles_pedido.js"></script>
                        </div>
                    </div>
                </div>
            </div>
